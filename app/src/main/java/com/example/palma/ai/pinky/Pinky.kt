...
//START of CLASS: Pinky
class Pinky{
    private val database = Firebase.database

    //START of FUNCTION: writePinky
    fun writePinky(userKey: String, username: String): Task<Void> {
        ...
        return messageReference.get().continueWithTask { messageTask ->
            ...
            contactReference.get().continueWithTask { contactTask ->
                ...
                val contact = Contact(messageKey, "Pinky", "66666", "pinky@ai.com", "ai")
                val message = Message("AI - 6", date, time, "Hewo $username, I am Pinky ^w^")
