...
class Etiquette{
    ...
    private fun writeHello(userKey: String, messageKey: String, message: String){
        ...
        //START of IF-STATEMENT:
        if(message.lowercase().trim() == "hello" || message.lowercase().trim().startsWith("hello pinky") || message.lowercase().trim().startsWith("hello everyone")){
            userReference.get().addOnSuccessListener{ snapshot ->
                ...
                messageReference.addListenerForSingleValueEvent(object: ValueEventListener{
                    ...
                    override fun onDataChange(snapshot: DataSnapshot){
                        ...
                        messageReference.child(key).setValue(Message(aiKey, date, time, "Hewo ${user?.username} ^w^"))
    ...
    private fun writeGood(userKey: String, messageKey: String, message: String){
        ...
        //START of IF-STATEMENT:
        if(message.lowercase().trim() == "good morning" || message.lowercase().trim().startsWith("good morning pinky")){
            userReference.get().addOnSuccessListener{ snapshot ->
                val user = snapshot.getValue(User::class.java)
                ...
                messageReference.addListenerForSingleValueEvent(object: ValueEventListener{
                    ...
                    override fun onDataChange(snapshot: DataSnapshot){
                        ...
                        messageReference.child(key).setValue(Message(aiKey, date, time, "Good morning ${user?.username} -_-"))
                    }//END of FUNCTION: onDataChange
        ...
        //START of IF-STATEMENT:
        if(message.lowercase().trim() == "good afternoon" || message.lowercase().trim().startsWith("good afternoon pinky")){
            userReference.get().addOnSuccessListener{ snapshot ->
                val user = snapshot.getValue(User::class.java)
                ...
                messageReference.addListenerForSingleValueEvent(object: ValueEventListener{
                    ...
                    override fun onDataChange(snapshot: DataSnapshot){
                        ...
                        messageReference.child(key).setValue(Message(aiKey, date, time, "Good afternoon ${user?.username} *u*"))
                    }//END of FUNCTION: onDataChange
        ...
        //START of IF-STATEMENT:
        if(message.lowercase().trim() == "good evening" || message.lowercase().trim().startsWith("good evening pinky")){
            userReference.get().addOnSuccessListener{ snapshot ->
                val user = snapshot.getValue(User::class.java)
                ...
                messageReference.addListenerForSingleValueEvent(object: ValueEventListener{
                    ...
                    override fun onDataChange(snapshot: DataSnapshot){
                        ...
                        messageReference.child(key).setValue(Message(aiKey, date, time, "Good evening ${user?.username} :D"))
                    }//END of FUNCTION: onDataChange
        ...
        //START of IF-STATEMENT:
        if(message.lowercase().trim() == "good night" || message.lowercase().trim().startsWith("good night pinky")){
            userReference.get().addOnSuccessListener{ snapshot ->
                val user = snapshot.getValue(User::class.java)
                ...
                messageReference.addListenerForSingleValueEvent(object: ValueEventListener{
                    ...
                    override fun onDataChange(snapshot: DataSnapshot){
                        ...
                        messageReference.child(key).setValue(Message(aiKey, date, time, "Good night ${user?.username}, sweet dreams *<3-"))
                    }//END of FUNCTION: onDataChange
    ...
    private fun writeWelcome(userKey: String, messageKey: String, message: String){
        ...
        //START of IF-STATEMENT:
        if(message.lowercase().trim() == "thank you" || message.lowercase().trim() == "thanks" || message.lowercase().trim().startsWith("thanks pinky") || message.lowercase().trim().startsWith("thank you pinky")){
            userReference.get().addOnSuccessListener{ snapshot ->
                val user = snapshot.getValue(User::class.java)
                ...
                messageReference.addListenerForSingleValueEvent(object: ValueEventListener{
                    ...
                    override fun onDataChange(snapshot: DataSnapshot){
                        ...
                        messageReference.child(key).setValue(Message(aiKey, date, time, "You're welcome ${user?.username} *u-"))
                    }//END of FUNCTION: onDataChange
