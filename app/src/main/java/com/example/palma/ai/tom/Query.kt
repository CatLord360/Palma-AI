        ...
        messageReference.addListenerForSingleValueEvent(object : ValueEventListener{
            ...
            override fun onDataChange(snapshot: DataSnapshot){
                ...
                val responseText = if (matchedAnswers.isNotEmpty()){
                    ...
                    //START of IF-STATEMENT:
                    if(isYesNoQuery){
                        "That\'s true, $replaced".replaceFirstChar { it.titlecase() }
                    }//END of IF-STATEMENT
                    ...
                    //START of ELSE-STATEMENT
                        ...
                        "Based on established information, ${replaced.replaceFirstChar{it.titlecase()}}"
                    }//END of ELSE-STATEMENT
                }
                ...
                //START of ELSE-IF STATEMENT:
                    ...
                    "That\'s false, $replaced".replaceFirstChar { it.titlecase() }
                }//END of ELSE-IF STATEMENT
                ...
                //START of ELSE-STATEMENT:
                    ...
                    //START of IF-STATEMENT:
                    if(isYesNoQuery){
                        "Unfortunately, I don't know if $cleaned"
                    }//END of IF-STATEMENT
