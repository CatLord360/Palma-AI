                ...
                userReference.get().addOnSuccessListener{ userSnapshot ->
                    ...
                    if(isPlural){
                        ...
                        val message = if(joined.isNotBlank()){
                            ...
                            "Unfortunately, I don't know $cleaned are."
                        }
                    ...
                    //START of IF-STATEMENT:
                        ...
                        if(list.any{it in selfKey}){
                            ...
                            //START of IF-STATEMENT:
                            if(matchCount >= 1){
                                val message = "That\'s true, $foundAnswer.".replaceFirstChar{it.titlecase()}
                            ...
                            //START of ELSE-STATEMENT:
                                ...
                                val message = "That\'s false, $foundAnswer.".replaceFirstChar{it.titlecase()}
                                messageReference.child(newLogKey).setValue(Message(aiKey, date, time, message))
                            ...
                            for(foundUser in userSnapshot.children){
                                ...
                                if(matchCount >= 1){
                                    ...
                                    val message = if(matchCount > 1){
                                        "That\'s true, $foundAnswer.".replaceFirstChar{it.titlecase()}
                                    } else{
                                        "That\'s false, $foundAnswer.".replaceFirstChar{it.titlecase()}
                                    }
                                ...
                                //START of ELSE-STATEMENT:
                                    ...
                                    val message = "Unfortunately, I don't know if $cleaned."
                                    messageReference.child(newLogKey).setValue(Message(aiKey, date, time, message))
                                }//END of ELSE-STATEMENT
                            }//END of FOR-LOOP
                        }//END of IF-STATEMENT
                        ...
                        if(list.any{it in selfKey}){
                            userReference.child("$userKey/Personal Information").get().addOnSuccessListener{ userSnapshot ->
                                ...
                                val message = if(joined.isNotBlank()){
                                    ...
                                    "Unfortunately, I don't know $cleaned is."
                                }
            ...
            override fun onDataChange(messageSnapshot: DataSnapshot){
                ...
                if((query.lowercase().contains(Regex("\\bare\\b"))) || (lastKeyword.endsWith("s") && !lastKeyword.endsWith("ss"))){
                    ...
                    //START of ELSE-STATEMENT:
                        ...
                        if((classification != "ai") && (classification != "user")){
                            message = "Unfortunately, I don't know $cleaned are."
                            messageReference.child(newLogKey).setValue(Message(aiKey, date, time, message))
                        }//END of IF-STATEMENT
                ...
                //START of IF-STATEMENT:
                    ...
                    if(answers.isNotEmpty()){
                        ...
                        if(answers.containsAll(keywords)){
                            message = "That\'s true, $replaced.".replaceFirstChar{it.titlecase()}
                        }//END of IF-STATEMENT

                        //START of ELSE-STATEMENT:
                        else{
                            message = "That\'s false, $replaced.".replaceFirstChar{it.titlecase()}
                        }//END of IF-STATEMENT
                    ...
                    //START of ELSE-STATEMENT:
                        ...
                        //START of IF-STATEMENT:
                        if((classification != "ai") && (classification != "user")){
                            message = "Unfortunately, I don't know if $cleaned."
                            messageReference.child(newLogKey).setValue(Message(aiKey, date, time, message))
                        }//END of IF-STATEMENT
                ...
                //START of ELSE-STATEMENT:
                    ...
                    if(foundAnswer.isNotBlank()){
                        ...
                        message = "Based on established information, $replaced."
                        messageReference.child(newLogKey).setValue(Message(aiKey, date, time, message))
                    }//END of IF-STATEMENT
                    ...
                    //START of ELSE-STATEMENT:
                        ...
                        //START of IF-STATEMENT:
                        if((classification != "ai") && (classification != "user")){
                            message = "Unfortunately, I don't know $cleaned is."
                            messageReference.child(newLogKey).setValue(Message(aiKey, date, time, message))
                        }//END of IF-STATEMENT
