...
class Rin{
    ...
    //START of FUNCTION: writeRin
    fun writeRin(userKey: String, username: String): Task<Void> {
        ...
        return messageReference.get().continueWithTask { messageTask ->
            ...
            contactReference.get().continueWithTask { contactTask ->
                ...
                val contact = Contact(messageKey, "Rin", "55555", "rin@ai.com", "ai")
                val message = Message("AI - 5", date, time, "Hi $username, I am Rin")
