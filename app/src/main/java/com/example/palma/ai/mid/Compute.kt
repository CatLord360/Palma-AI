        ...
        userReference.get().addOnSuccessListener{ snapshot ->
            messageReference.addListenerForSingleValueEvent(object: ValueEventListener{
                ...
                override fun onDataChange(snapshot: DataSnapshot){
                    ...
                    messageReference.child(key).setValue(Message(aiKey, date, time, "The sum of ${list.joinToString(" ")} is $sum Dumbass!!!"))
        ...
        userReference.get().addOnSuccessListener{ snapshot ->
            messageReference.addListenerForSingleValueEvent(object: ValueEventListener{
                ...
                override fun onDataChange(snapshot: DataSnapshot){
                    ...
                    messageReference.child(key).setValue(Message(aiKey, date, time, "The difference of ${list.joinToString(" ")} is $difference Dumbass!!!"))
                }//END of FUNCTION: onDataChange
        ...
        userReference.get().addOnSuccessListener{ snapshot ->
            messageReference.addListenerForSingleValueEvent(object: ValueEventListener{
                ...
                override fun onDataChange(snapshot: DataSnapshot){
                    ...
                    messageReference.child(key).setValue(Message(aiKey, date, time, "The product of ${list.joinToString(" ")} is $product Dumbass!!!"))
                }//END of FUNCTION: onDataChange
        ...
        userReference.get().addOnSuccessListener{ snapshot ->
            messageReference.addListenerForSingleValueEvent(object: ValueEventListener{
                ...
                override fun onDataChange(snapshot: DataSnapshot){
                    ...
                    messageReference.child(key).setValue(Message(aiKey, date, time, "The quotient of ${list.joinToString(" ")} is $quotient Dumbass!!!"))
                }//END of FUNCTION: onDataChange
        ...
        userReference.get().addOnSuccessListener{ snapshot ->
            messageReference.addListenerForSingleValueEvent(object: ValueEventListener{
                ...
                override fun onDataChange(snapshot: DataSnapshot){
                    ...
                    messageReference.child(key).setValue(Message(aiKey, date, time, "The modulus of ${list.joinToString(" ")} is $modulus Dumbass!!!"))
                }//END of FUNCTION: onDataChange
        ...
        userReference.get().addOnSuccessListener{ snapshot ->
            messageReference.addListenerForSingleValueEvent(object: ValueEventListener{
                ...
                override fun onDataChange(snapshot: DataSnapshot){
                    ...
                    messageReference.child(key).setValue(Message(aiKey, date, time, "The average of ${list.joinToString(" ")} is $average Dumbass!!!"))
                }//END of FUNCTION: onDataChange
        ...
        userReference.get().addOnSuccessListener{ snapshot ->
            messageReference.addListenerForSingleValueEvent(object: ValueEventListener{
                ...
                override fun onDataChange(snapshot: DataSnapshot){
                    ...
                    messageReference.child(key).setValue(Message(aiKey, date, time, "The square of ${list.joinToString(" ")} is $square Dumbass!!!"))
                }//END of FUNCTION: onDataChange
        ...
        userReference.get().addOnSuccessListener{ snapshot ->
            messageReference.addListenerForSingleValueEvent(object: ValueEventListener{
                ...
                override fun onDataChange(snapshot: DataSnapshot){
                    ...
                    messageReference.child(key).setValue(Message(aiKey, date, time, "The cube of ${list.joinToString(" ")} is $cube Dumbass!!!"))
                }//END of FUNCTION: onDataChange
        ...
        userReference.get().addOnSuccessListener{ snapshot ->
            messageReference.addListenerForSingleValueEvent(object: ValueEventListener{
                ...
                override fun onDataChange(snapshot: DataSnapshot){
                    ...
                    messageReference.child(key).setValue(Message(aiKey, date, time, "The factorial of ${list.joinToString(" ")} is ${factorial(list[0])} Dumbass!!!"))
                }//END of FUNCTION: onDataChange
        ...
        userReference.get().addOnSuccessListener{ snapshot ->
            messageReference.addListenerForSingleValueEvent(object: ValueEventListener{
                ...
                override fun onDataChange(snapshot: DataSnapshot){
                    ...
                    messageReference.child(key).setValue(Message(aiKey, date, time, "The gcd of ${list.joinToString(" ")} is ${list.reduce { acc, num -> gcd(acc, num)}} Dumbass!!!"))
                }//END of FUNCTION: onDataChange
        ...
        userReference.get().addOnSuccessListener{ snapshot ->
            messageReference.addListenerForSingleValueEvent(object : ValueEventListener {
                ...
                override fun onDataChange(snapshot: DataSnapshot) {
                    ...
                    messageReference.child(key).setValue(Message(aiKey, date, time, "The lcm of ${list.joinToString(" ")} is ${list.reduce { acc, num -> lcm(acc, num) }} Dumbass!!!"))
                }//END of FUNCTION: onDataChange
        ...
        userReference.get().addOnSuccessListener{ snapshot ->
            messageReference.addListenerForSingleValueEvent(object: ValueEventListener{
                ...
                override fun onDataChange(snapshot: DataSnapshot){
                    ...
                    messageReference.child(key).setValue(Message(aiKey, date, time, "The percentage of ${list.joinToString(" ")} is $percentage% Dumbass!!!"))
                }//END of FUNCTION: onDataChange
        ...
        userReference.get().addOnSuccessListener{ snapshot ->
            messageReference.addListenerForSingleValueEvent(object: ValueEventListener{
                ...
                override fun onDataChange(snapshot: DataSnapshot){
                    ...
                    messageReference.child(key).setValue(Message(aiKey, date, time, "The absolute of ${list.joinToString(" ")} is $absolute Dumbass!!!"))
                }//END of FUNCTION: onDataChange
        ...
        userReference.get().addOnSuccessListener{ snapshot ->
            messageReference.addListenerForSingleValueEvent(object: ValueEventListener{
                ...
                override fun onDataChange(snapshot: DataSnapshot){
                    ...
                    messageReference.child(key).setValue(Message(aiKey, date, time, "The round of ${list.joinToString(" ")} is $round Dumbass!!!"))
                }//END of FUNCTION: onDataChange
