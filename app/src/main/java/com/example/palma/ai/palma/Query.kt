...
class Query{
    ...
    fun writeQuery(userKey: String, messageKey: String, message: String){
        ...
        val keywords = list.filter{it.isNotBlank() && it !in cancel}
                ...
                //START of IF-STATEMENT:
                    ...
                    if(answers.isNotEmpty()){
                        ...
                        if(answers.containsAll(keywords)){
                            message = "Fortunately, $replaced.".replaceFirstChar{it.titlecase()}
                        }//END of IF-STATEMENT

                        //START of ELSE-STATEMENT:
                        else{
                            message = "Unfortunately, $replaced.".replaceFirstChar{it.titlecase()}
                        }//END of IF-STATEMENT
