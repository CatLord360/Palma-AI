...
class Query{
    ...
    private fun queryAI(messageKey: String, message: String){
        ...
        val keywords = words.filter { it !in cancel }.toSet()
                ...
                userReference.get().addOnSuccessListener{ userSnapshot ->
                    ...
                    if(isPlural){
                        ...
                        val message = if(joined.isNotBlank()){
                            "The $requirements of matching users are $joined."
                        }else{
                            "I apologize, but I could not find the $requirements you requested."
                        }
                    ...
                    //START of IF-STATEMENT:
                        ...
                        if(list.any{it in selfKey}){
                            ...
                            //START of IF-STATEMENT:
                            if(matchCount >= 1){
                                val message = "Fortunately, $foundAnswer is true.".replaceFirstChar{it.titlecase()}
                            ...
                            //START of ELSE-STATEMENT:
                                ...
                                val message = "Unfortunately, $foundAnswer is false.".replaceFirstChar{it.titlecase()}
                                messageReference.child(newLogKey).setValue(Message(aiKey, date, time, message))
                            ...
                            for(foundUser in userSnapshot.children){
                                ...
                                if(matchCount >= 1){
                                    ...
                                    val message = if(matchCount > 1){
                                        "Fortunately, $foundAnswer is true.".replaceFirstChar{it.titlecase()}
                                    } else{
                                        "Unfortunately, $foundAnswer is false.".replaceFirstChar{it.titlecase()}
                                    }
                                ...
                                //START of ELSE-STATEMENT:
                                    ...
                                    val message = "I apologize, but I could not find the information you requested."
                                    messageReference.child(newLogKey).setValue(Message(aiKey, date, time, message))
                                }//END of ELSE-STATEMENT
                            }//END of FOR-LOOP
                        }//END of IF-STATEMENT
            ...
            override fun onDataChange(messageSnapshot: DataSnapshot){
                ...
                //START of IF-STATEMENT:
                    ...
                    if(answers.isNotEmpty()){
                        ...
                        val message = if(answers.containsAll(keywords)){
                ...
                //START of ELSE-STATEMENT:
                    ...
                    if(foundAnswer.isNotBlank()){
                        ...
                        message = "According to my knowledge, $replaced."
                        messageReference.child(newLogKey).setValue(Message(aiKey, date, time, message))
                    }//END of IF-STATEMENT
                    ...
                    //START of ELSE-STATEMENT:
                        ...
                        //START of IF-STATEMENT:
                        if((classification != "ai") && (classification != "user")){
                            message = "I don't know $cleaned is."
                            messageReference.child(newLogKey).setValue(Message(aiKey, date, time, message))
                        }//END of IF-STATEMENT
