        ...
        messageReference.addListenerForSingleValueEvent(object : ValueEventListener{
            ...
            override fun onDataChange(snapshot: DataSnapshot){
                ...
                val responseText = if (matchedAnswers.isNotEmpty()){
                    ...
                    //START of IF-STATEMENT:
                    if(isYesNoQuery){
                        "Yep, $replaced".replaceFirstChar { it.titlecase() }
                    }//END of IF-STATEMENT
                    ...
                    //START of ELSE-STATEMENT
                        ...
                        "${replaced.replaceFirstChar{it.titlecase()}} :D"
                    }//END of ELSE-STATEMENT
                }
                ...
                //START of ELSE-IF STATEMENT:
                    ...
                    "Nope, $replaced".replaceFirstChar { it.titlecase() }
                }//END of ELSE-IF STATEMENT
                ...
                //START of ELSE-STATEMENT:
                    ...
                    //START of IF-STATEMENT:
                    if(isYesNoQuery){
                        "I'm sowwy, I don't know $cleaned TT.TT"
                    }//END of IF-STATEMENT
                    ...
                    //START of ELSE-STATEMENT:
                        ...
                        "I'm sowwy, I don't know $cleaned is TT0TT"
                    }//END of ELSE-STATEMENT
                }//END of ELSE-STATEMENT
