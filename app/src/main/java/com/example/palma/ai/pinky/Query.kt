...
class Query{
    ...
    //START of FUNCTION: uwu
    fun uwu(text: String): String{
        return text
            .replace(Regex("[rl]"), "w")
            .replace(Regex("[RL]"), "W")
            .replace("no", "nu")
    ...
    private fun queryAI(messageKey: String, message: String){
        ...
        val responseText = if (matchedData != null && matchedLabel != null) {
            ...
            "My $phrase is $matchedData :D".replaceFirstChar { it.uppercase() }
        } else {
                ...
                userReference.get().addOnSuccessListener{ userSnapshot ->
                    ...
                    if(isPlural){
                        ...
                        val message = if(joined.isNotBlank()){
                            ...
                            "I'm sowwy, I don't know $cleaned are TToTT"
                        }

                        messageReference.child(newLogKey).setValue(Message(aiKey, date, time, uwu(message)))
                    }//END of IF-STATEMENT
                    ...
                    //START of IF-STATEMENT:
                        ...
                        if(list.any{it in selfKey}){
                            ...
                            //START of IF-STATEMENT:
                            if(matchCount >= 1){
                                val message = "Yep, ${uwu(foundAnswer)}.".replaceFirstChar{it.titlecase()}
                            ...
                            //START of ELSE-STATEMENT:
                                ...
                                val message = "Nope, ${uwu(foundAnswer)}.".replaceFirstChar{it.titlecase()}
                                messageReference.child(newLogKey).setValue(Message(aiKey, date, time, message))
                            ...
                            for(foundUser in userSnapshot.children){
                                ...
                                if(matchCount >= 1){
                                    ...
                                    val message = if(matchCount > 1){
                                        "Yep, ${uwu(foundAnswer)}.".replaceFirstChar{it.titlecase()}
                                    } else{
                                        "Nope, ${uwu(foundAnswer)}.".replaceFirstChar{it.titlecase()}
                                    }
                                ...
                                //START of ELSE-STATEMENT:
                                    ...
                                    val message = "I'm sowwy, I don't know ${uwu(cleaned)} TT.TT"
                                    messageReference.child(newLogKey).setValue(Message(aiKey, date, time, message))
                                }//END of ELSE-STATEMENT
                            }//END of FOR-LOOP
                        }//END of IF-STATEMENT
                        ...
                        if(list.any{it in selfKey}){
                            userReference.child("$userKey/Personal Information").get().addOnSuccessListener{ userSnapshot ->
                                ...
                                val message = if(joined.isNotBlank()){
                                    ...
                                    "I'm sowwy, I don't know ${uwu(cleaned)} is TT0TT"
                                }
            ...
            override fun onDataChange(messageSnapshot: DataSnapshot){
                ...
                if((query.lowercase().contains(Regex("\\bare\\b"))) || (lastKeyword.endsWith("s") && !lastKeyword.endsWith("ss"))){
                    ...
                    //START of ELSE-STATEMENT:
                        ...
                        if((classification != "ai") && (classification != "user")){
                            message = "I'm sowwy, I don't know ${uwu(cleaned)} are TToTT"
                            messageReference.child(newLogKey).setValue(Message(aiKey, date, time, message))
                        }//END of IF-STATEMENT
                ...
                //START of IF-STATEMENT:
                    ...
                    if(answers.isNotEmpty()){
                        ...
                        if(answers.containsAll(keywords)){
                            message = "Yep, ${uwu(replaced)}.".replaceFirstChar{it.titlecase()}
                        }//END of IF-STATEMENT

                        //START of ELSE-STATEMENT:
                        else{
                            message = "Nope, ${uwu(replaced)}.".replaceFirstChar{it.titlecase()}
                        }//END of IF-STATEMENT
                    ...
                    //START of ELSE-STATEMENT:
                        ...
                        //START of IF-STATEMENT:
                        if((classification != "ai") && (classification != "user")){
                            message = "I'm sowwy, I don't know ${uwu(cleaned)} TT.TT"
                            messageReference.child(newLogKey).setValue(Message(aiKey, date, time, message))
                        }//END of IF-STATEMENT
                ...
                //START of ELSE-STATEMENT:
                    ...
                    if(foundAnswer.isNotBlank()){
                        ...
                        message = "${replaced.replaceFirstChar{it.titlecase()}} :D"
                        messageReference.child(newLogKey).setValue(Message(aiKey, date, time, message))
                    }//END of IF-STATEMENT
                    ...
                    //START of ELSE-STATEMENT:
                        ...
                        //START of IF-STATEMENT:
                        if((classification != "ai") && (classification != "user")){
                            message = "I'm sowwy, I don't know ${uwu(cleaned)} is TT0TT"
                            messageReference.child(newLogKey).setValue(Message(aiKey, date, time, message))
                        }//END of IF-STATEMENT
