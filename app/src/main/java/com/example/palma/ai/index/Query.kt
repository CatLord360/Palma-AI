                ...
                userReference.get().addOnSuccessListener{ userSnapshot ->
                    ...
                    if(isPlural){
                        ...
                        val message = if(joined.isNotBlank()){
                            ...
                            "Sadly, I don't know $cleaned are."
                        }
                    ...
                    //START of IF-STATEMENT:
                        ...
                        if(list.any { it in selfKey }){
                            ...
                            //START of IF-STATEMENT:
                            if(matchCount >= 1){
                                val message = "Yes, $foundAnswer.".replaceFirstChar{it.titlecase()}
                            ...
                            //START of ELSE-STATEMENT:
                                ...
                                val message = "No, $foundAnswer.".replaceFirstChar{it.titlecase()}
                                messageReference.child(newLogKey).setValue(Message(aiKey, date, time, message))
                            }//END of ELSE-STATEMENT
                        }//END of IF-STATEMENT
                            ...
                            for(foundUser in userSnapshot.children){
                                ...
                                if(matchCount >= 1){
                                    ...
                                    val message = if(matchCount > 1){
                                        "Yes, $foundAnswer.".replaceFirstChar{it.titlecase()}
                                    } else{
                                        "No, $foundAnswer.".replaceFirstChar{it.titlecase()}
                                    }
                                ...
                                //START of ELSE-STATEMENT:
                                    ...
                                    val message = "Sadly, I don't know $cleaned."
                                    messageReference.child(newLogKey).setValue(Message(aiKey, date, time, message))
                                }//END of ELSE-STATEMENT
                            }//END of FOR-LOOP
                        }//END of IF-STATEMENT
            ...
            override fun onDataChange(messageSnapshot: DataSnapshot){
                ...
                if((query.lowercase().contains(Regex("\\bare\\b"))) || (lastKeyword.endsWith("s") && !lastKeyword.endsWith("ss"))){
                    ...
                    //START of ELSE-STATEMENT:
                        ...
                        if((classification != "ai") && (classification != "user")){
                            message = "Sadly, I don't know $cleaned are."
                            messageReference.child(newLogKey).setValue(Message(aiKey, date, time, message))
                        }//END of IF-STATEMENT
                ...
                //START of IF-STATEMENT:
                    ...
                    if(answers.isNotEmpty()){
                        ...
                        if(answers.containsAll(keywords)){
                            message = "Yes, $replaced.".replaceFirstChar{it.titlecase()}
                        }//END of IF-STATEMENT

                        //START of ELSE-STATEMENT:
                        else{
                            message = "No, $replaced.".replaceFirstChar{it.titlecase()}
                        }//END of IF-STATEMENT
                    ...
                    //START of ELSE-STATEMENT:
                        ...
                        //START of IF-STATEMENT:
                        if((classification != "ai") && (classification != "user")){
                            message = "Sadly, I don't know $cleaned."
                            messageReference.child(newLogKey).setValue(Message(aiKey, date, time, message))
                        }//END of IF-STATEMENT
                ...
                //START of ELSE-STATEMENT:
                    ...
                    if(foundAnswer.isNotBlank()){
                        ...
                        message = "From what I know, $replaced."
                        messageReference.child(newLogKey).setValue(Message(aiKey, date, time, message))
                    }//END of IF-STATEMENT
                    ...
                    //START of ELSE-STATEMENT:
                        ...
                        //START of IF-STATEMENT:
                        if((classification != "ai") && (classification != "user")){
                            message = "Sadly, I don't know $cleaned is."
                            messageReference.child(newLogKey).setValue(Message(aiKey, date, time, message))
                        }//END of IF-STATEMENT
