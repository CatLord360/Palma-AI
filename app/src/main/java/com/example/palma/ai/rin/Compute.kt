        ...
        userReference.get().addOnSuccessListener{ snapshot ->
            messageReference.addListenerForSingleValueEvent(object: ValueEventListener{
                ...
                override fun onDataChange(snapshot: DataSnapshot){
                    ...
                    messageReference.child(key).setValue(Message(aiKey, date, time, "The sum of ${list.joinToString(" ")} is $sum Darling..."))
        ...
        userReference.get().addOnSuccessListener{ snapshot ->
            messageReference.addListenerForSingleValueEvent(object: ValueEventListener{
                ...
                override fun onDataChange(snapshot: DataSnapshot){
                    ...
                    messageReference.child(key).setValue(Message(aiKey, date, time, "The difference of ${list.joinToString(" ")} is $difference Darling..."))
                }//END of FUNCTION: onDataChange
        ...
        userReference.get().addOnSuccessListener{ snapshot ->
            messageReference.addListenerForSingleValueEvent(object: ValueEventListener{
                ...
                override fun onDataChange(snapshot: DataSnapshot){
                    ...
                    messageReference.child(key).setValue(Message(aiKey, date, time, "The product of ${list.joinToString(" ")} is $product Darling..."))
                }//END of FUNCTION: onDataChange
        ...
        userReference.get().addOnSuccessListener{ snapshot ->
            messageReference.addListenerForSingleValueEvent(object: ValueEventListener{
                ...
                override fun onDataChange(snapshot: DataSnapshot){
                    ...
                    messageReference.child(key).setValue(Message(aiKey, date, time, "The quotient of ${list.joinToString(" ")} is $quotient Darling..."))
                }//END of FUNCTION: onDataChange
        ...
        userReference.get().addOnSuccessListener{ snapshot ->
            messageReference.addListenerForSingleValueEvent(object: ValueEventListener{
                ...
                override fun onDataChange(snapshot: DataSnapshot){
                    ...
                    messageReference.child(key).setValue(Message(aiKey, date, time, "The modulus of ${list.joinToString(" ")} is $modulus Darling..."))
                }//END of FUNCTION: onDataChange
        ...
        userReference.get().addOnSuccessListener{ snapshot ->
            messageReference.addListenerForSingleValueEvent(object: ValueEventListener{
                ...
                override fun onDataChange(snapshot: DataSnapshot){
                    ...
                    messageReference.child(key).setValue(Message(aiKey, date, time, "The average of ${list.joinToString(" ")} is $average Darling..."))
                }//END of FUNCTION: onDataChange
        ...
        userReference.get().addOnSuccessListener{ snapshot ->
            messageReference.addListenerForSingleValueEvent(object: ValueEventListener{
                ...
                override fun onDataChange(snapshot: DataSnapshot){
                    ...
                    messageReference.child(key).setValue(Message(aiKey, date, time, "The square of ${list.joinToString(" ")} is $square Darling..."))
                }//END of FUNCTION: onDataChange
        ...
        userReference.get().addOnSuccessListener{ snapshot ->
            messageReference.addListenerForSingleValueEvent(object: ValueEventListener{
                ...
                override fun onDataChange(snapshot: DataSnapshot){
                    ...
                    messageReference.child(key).setValue(Message(aiKey, date, time, "The cube of ${list.joinToString(" ")} is $cube Darling..."))
                }//END of FUNCTION: onDataChange
        ...
        userReference.get().addOnSuccessListener{ snapshot ->
            messageReference.addListenerForSingleValueEvent(object: ValueEventListener{
                ...
                override fun onDataChange(snapshot: DataSnapshot){
                    ...
                    messageReference.child(key).setValue(Message(aiKey, date, time, "The factorial of ${list.joinToString(" ")} is ${factorial(list[0])} Darling..."))
                }//END of FUNCTION: onDataChange
        ...
        userReference.get().addOnSuccessListener{ snapshot ->
            messageReference.addListenerForSingleValueEvent(object: ValueEventListener{
                ...
                override fun onDataChange(snapshot: DataSnapshot){
                    ...
                    messageReference.child(key).setValue(Message(aiKey, date, time, "The gcd of ${list.joinToString(" ")} is ${list.reduce { acc, num -> gcd(acc, num)}} Darling..."))
                }//END of FUNCTION: onDataChange
        ...
        userReference.get().addOnSuccessListener{ snapshot ->
            messageReference.addListenerForSingleValueEvent(object : ValueEventListener {
                ...
                override fun onDataChange(snapshot: DataSnapshot) {
                    ...
                    messageReference.child(key).setValue(Message(aiKey, date, time, "The lcm of ${list.joinToString(" ")} is ${list.reduce { acc, num -> lcm(acc, num) }} Darling..."))
                }//END of FUNCTION: onDataChange
        ...
        userReference.get().addOnSuccessListener{ snapshot ->
            messageReference.addListenerForSingleValueEvent(object: ValueEventListener{
                ...
                override fun onDataChange(snapshot: DataSnapshot){
                    ...
                    messageReference.child(key).setValue(Message(aiKey, date, time, "The percentage of ${list.joinToString(" ")} is $percentage% Darling..."))
                }//END of FUNCTION: onDataChange
        ...
        userReference.get().addOnSuccessListener{ snapshot ->
            messageReference.addListenerForSingleValueEvent(object: ValueEventListener{
                ...
                override fun onDataChange(snapshot: DataSnapshot){
                    ...
                    messageReference.child(key).setValue(Message(aiKey, date, time, "The absolute of ${list.joinToString(" ")} is $absolute Darling..."))
                }//END of FUNCTION: onDataChange
        ...
        userReference.get().addOnSuccessListener{ snapshot ->
            messageReference.addListenerForSingleValueEvent(object: ValueEventListener{
                ...
                override fun onDataChange(snapshot: DataSnapshot){
                    ...
                    messageReference.child(key).setValue(Message(aiKey, date, time, "The round of ${list.joinToString(" ")} is $round Darling..."))
                }//END of FUNCTION: onDataChange
