...
class Etiquette{
    ...
    private fun writeHello(userKey: String, messageKey: String, message: String){
        ...
        //START of IF-STATEMENT:
        if(message.lowercase().trim() == "hello" || message.lowercase().trim().startsWith("hello palma") || message.lowercase().trim().startsWith("hello everyone")){
    ...
    private fun writeGood(userKey: String, messageKey: String, message: String){
        ...
        //START of IF-STATEMENT:
        if(message.lowercase().trim() == "good morning" || message.lowercase().trim().startsWith("good morning palma")){
            userReference.get().addOnSuccessListener{ snapshot ->
                val user = snapshot.getValue(User::class.java)
        ...
        //START of IF-STATEMENT:
        if(message.lowercase().trim() == "good afternoon" || message.lowercase().trim().startsWith("good afternoon palma")){
            userReference.get().addOnSuccessListener{ snapshot ->
                val user = snapshot.getValue(User::class.java)
        ...
        //START of IF-STATEMENT:
        if(message.lowercase().trim() == "good evening" || message.lowercase().trim().startsWith("good evening palma")){
            userReference.get().addOnSuccessListener{ snapshot ->
                val user = snapshot.getValue(User::class.java)
        ...
        //START of IF-STATEMENT:
        if(message.lowercase().trim() == "good night" || message.lowercase().trim().startsWith("good night palma")){
            userReference.get().addOnSuccessListener{ snapshot ->
                val user = snapshot.getValue(User::class.java)
    ...
    private fun writeWelcome(userKey: String, messageKey: String, message: String){
        ...
        //START of IF-STATEMENT:
        if(message.lowercase().trim() == "thank you" || message.lowercase().trim() == "thanks" || message.lowercase().trim().startsWith("thanks palma") || message.lowercase().trim().startsWith("thank you palma")){
            userReference.get().addOnSuccessListener{ snapshot ->
                val user = snapshot.getValue(User::class.java)
